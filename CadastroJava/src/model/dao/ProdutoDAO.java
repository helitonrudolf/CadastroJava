...
public class ProdutoDAO {
    ...
    public List<Produto> findAll(int idCategoria){
        String sql = "SELECT idCategoria, idProduto, p.descricao AS pdesc, qtd, valor, c.descricao AS cdesc FROM produto AS p "
                + "INNER JOIN categoria AS c USING(idCategoria) WHERE P.idCategoria = ?";
        PreparedStatement stmt = null;
        ResultSet rs = null;
